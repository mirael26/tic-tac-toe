...
module.exports = __webpack_require__.p + "images/board.png";
...
module.exports = __webpack_require__.p + "images/cross.png";
...
module.exports = __webpack_require__.p + "images/line-1.png";
...
module.exports = __webpack_require__.p + "images/line-2.png";
...
module.exports = __webpack_require__.p + "images/zero.png";
...
;// CONCATENATED MODULE: ./src/store/action.ts
var ActionType = {
...
var ActionCreator = {
    updateGameData: function (gameData) { return ({
        type: ActionType.UPDATE_GAME_DATA,
        payload: gameData
    }); },
    changePlayer: function () { return ({
        type: ActionType.CHANGE_PLAYER,
    }); },
    updateGameStatus: function (gameStatus) { return ({
        type: ActionType.UPDATE_GAME_STATUS,
        payload: gameStatus
    }); },
    updateWinner: function (winner) { return ({
        type: ActionType.UPDATE_WINNER,
        payload: winner,
    }); },
    resetGame: function () { return ({
...
var reducer = function (state, action) {
    ...
    switch (action.type) {
        case ActionType.UPDATE_GAME_DATA:
            return __assign(__assign({}, state), { gameData: action.payload });
        case ActionType.CHANGE_PLAYER:
            return __assign(__assign({}, state), { currentPlayer: Number(!state.currentPlayer) });
        case ActionType.UPDATE_GAME_STATUS:
            return __assign(__assign({}, state), { gameStatus: action.payload });
        case ActionType.UPDATE_WINNER:
            return __assign(__assign({}, state), { winner: action.payload });
...
var CellImage = {
    CROSS: __webpack_require__(907),
    ZERO: __webpack_require__(468)
};
var Cell = function (_a) {
    var value = _a.value, cellId = _a.cellId;
    var cellImage;
    if (value !== null) {
        cellImage = (value === 1) ? CellImage.CROSS : CellImage.ZERO;
    }
    return (react.createElement("div", { className: "cell", id: cellId.toString() }, value !== null && cellImage
        ? react.createElement("img", { className: "cell__image", src: cellImage, alt: "\u044F\u0447\u0435\u0439\u043A\u0430" })
        : null));
};
/* harmony default export */ var cell = (Cell);

;// CONCATENATED MODULE: ./src/components/win-line/win-line.tsx

var LineImage = {
    STRAIGHT: __webpack_require__(231),
    DIAGONAL: __webpack_require__(909),
};
var WinLine = function (_a) {
    var combination = _a.combination;
    var lineImage = (combination === 'diagonal_1' || combination === 'diagonal_2') ? LineImage.DIAGONAL : LineImage.STRAIGHT;
    return (react.createElement("div", { className: "win-line ".concat(combination) },
        react.createElement("div", { className: "win-line__wrapper" },
            react.createElement("img", { className: "win-line__image", src: lineImage, alt: 'win-line' }))));
};
/* harmony default export */ var win_line = (WinLine);

;// CONCATENATED MODULE: ./src/components/board/board.tsx
...
var isBoardFull = function (gameData) {
    return gameData.filter(function (cell) { return cell === null; }).length === 0;
};
var findCombination = function (gameData) {
    var result = Object.keys(Combinations).find(function (combination) {
        var _a = Combinations[combination], a = _a[0], b = _a[1], c = _a[2];
...
var Board = function () {
    var _a = (0,react.useState)(null), winCombination = _a[0], setWinCombination = _a[1];
    var _b = (0,react.useState)(false), isDisabled = _b[0], setDisabled = _b[1];
    var cellValues = useSelector(function (state) { return state.gameData; });
    var currentPlayer = useSelector(function (state) { return state.currentPlayer; });
    var dispatch = useDispatch();
    (0,react.useEffect)(function () {
        var combination = findCombination(cellValues);
        if (combination) {
            setTimeout(function () {
                dispatch(ActionCreator.updateWinner(Number(!currentPlayer)));
    ...
    var onBoardClick = function (evt) {
        ...
        var newGameData = cellValues.slice();
        newGameData[cellId] = currentPlayer;
        dispatch(ActionCreator.updateGameData(newGameData));
        dispatch(ActionCreator.changePlayer());
    };
    return (react.createElement("div", { className: "board", onClick: onBoardClick },
        cellValues.map(function (el, id) {
            return react.createElement(cell, { key: "cell-".concat(id), value: el, cellId: id });
        }),
        winCombination
            ? react.createElement(win_line, { combination: winCombination })
            : null,
        react.createElement("img", { className: "board__image", src: __webpack_require__(990), alt: "game board" })));
};
/* harmony default export */ var board = (Board);

;// CONCATENATED MODULE: ./src/components/result/result.tsx
...
var Result = function () {
    var winner = useSelector(function (state) { return state.winner; });
    var dispatch = useDispatch();
    var winnerText = WinnerText.DRAWN;
    ...
    return (react.createElement("div", { className: "result" },
        react.createElement("h2", { className: "result__title" }, "\u041A\u043E\u043D\u0435\u0446 \u0438\u0433\u0440\u044B!"),
        react.createElement("p", { className: "result__text", style: {
                width: "".concat(winnerText.length, "ch"),
                animation: "printed-text 3s steps(".concat(winnerText.length, ")")
            } }, winnerText),
        react.createElement("button", { className: "result__button", onClick: resetGame }, "\u041D\u0430\u0447\u0430\u0442\u044C \u0437\u0430\u043D\u043E\u0432\u043E")));
};
/* harmony default export */ var result = (Result);

;// CONCATENATED MODULE: ./src/components/game/game.tsx




var Game = function () {
    var gameStatus = useSelector(function (state) { return state.gameStatus; });
    return (react.createElement("div", { className: "game" },
        react.createElement("h1", { className: "game__heading" }, "Tic-tac-toe"),
        gameStatus === 'play'
            ? react.createElement(board, null)
            : react.createElement(result, null)));
};
/* harmony default export */ var game = (Game);
...
var root = client/* createRoot */.s(document.getElementById('root'));
root.render(react.createElement(components_Provider, { store: store_store },
